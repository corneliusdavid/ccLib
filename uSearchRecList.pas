...
/// </param>
/// <example>
///   MySearchList := TList&lt;TSearchRec&gt;.Create; <br /><br />
///   GetSearchRecs(edtPath.Text, edtExt.Text, True, <br />procedure (const
///   Path: string; var Stop: Boolean) <br />begin <br />
///   StatusBar1.Panels[0].Text := Path; <br />StatusBar1.Update; <br />
///   Application.ProcessMessages; <br /><br />Stop := DoStop; <br />end, <br />
    ...
    try
      repeat
        if SearchRec.Attr and System.SysUtils.faDirectory <> 0 then begin
          ...
          if Recursive and (SearchRec.Name <> FCCurrentDir) and (SearchRec.Name <> FCParentDir) then
          ...
          // found a file matching our pattern, add it to the list
